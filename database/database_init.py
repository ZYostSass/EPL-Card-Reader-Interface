...
def init_database(session, dev=False):
    ...
    if dev:
        ...
        student1 = class_models.User(psu_id="900000011", access="000011", fname="John",
    ...
    circuit_board_manufacturing = class_models.MachineTag(
        "Circuit Board Manufacturing")
    ...
    machine0 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/circuit_board_manufacturing/lpkf_multipress_s.jpg")
    )
    ...
    machine1 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/circuit_board_manufacturing/lpkf_s63_pcb_router.jpg")
    )
    ...
    machine2 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/circuit_board_manufacturing/lpkf_s104_pcb_router.jpg")
    )
    ...
    machine3 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/circuit_board_manufacturing/pick_and_place.jpg")
    )
    ...
    machine4 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/circuit_board_manufacturing/soldering_equipment.jpg")
    )
    ...
    machine5 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/circuit_board_manufacturing/t200n_desktop_solder_oven.jpg")
    )
    ...
    machine6 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/circuit_board_manufacturing/test_and_measurement.jpg")
    )
    ...
    machine8 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/3d_printers/ultimaker3_extended_3d_printer.jpg")
    )
    ...
    machine9 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/machining_equipment/drill_press.jpg")
    )
    ...
    machine10 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/machining_equipment/little_machine_shop_lathe.jpg")
    )
    ...
    machine11 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/machining_equipment/little_machine_shop_mill.jpg")
    )
    ...
    machine13 = class_models.Machine(
        ...
        file_name=(
            prefix + "equipment_images/laser_cutters/qd-1390_laser_cutter.jpg")
    )
    ...
    if dev:
        ...
        log1 = class_models.TrainingLog(
            user=student1, machine=machine1, trained_at=datetime.now() - timedelta(days=2))
        log2 = class_models.TrainingLog(
            user=student1, machine=machine14, trained_at=datetime.now() - timedelta(days=1))
        log3 = class_models.TrainingLog(
            user=student2, machine=machine5, trained_at=datetime.now() - timedelta(days=1))
